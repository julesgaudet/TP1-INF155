...
L'�mission dans la distribution uniforme obtenue des deux paramètres

PARAMETRE(s) : les deux valeurs entières quelconques  servent 
               de bornes é l'intervalle
...
SPECS : celle-ci a une parité d'émission
	...
	en cours d'exécution de la simulation ( ce qui en réalité ne doit JAMAIS �tre fait)
*/
